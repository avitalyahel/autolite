    ...
    if arguments['list']:
        if arguments['--recursive']:
            ...
            if arguments['--YAML'] or arguments['--JSON']:
                common.dump(_task_lineage_dicts(parent=name, include=lineage_filter), 
                    toyaml=arguments['--YAML'], 
                    tojson=arguments['--JSON'],
                )

            else:
                _print_task_lineage(_task_lineage_dicts(parent=name, include=lineage_filter), long=arguments['--long'])
...
def _task_lineage_dicts(parent: str = '', include = lambda task: True) -> [dict]:
    tasks = []
    stack = [tasks]
